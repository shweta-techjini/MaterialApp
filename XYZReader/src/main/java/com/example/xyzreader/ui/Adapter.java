...
//                Bitmap bitmap = holder.thumbnailView.getDrawingCache();
//                if (bitmap != null) {
//                    Log.d("ArticleListActivity", "bitmap is not null");
//                    Palette p = Palette.from(bitmap).generate();
//                    int mMutedColor = p.getDarkMutedColor(0xFF333333);
//                    holder.titleLayout.setBackgroundColor(mMutedColor);
//                }
//            }
//        });
